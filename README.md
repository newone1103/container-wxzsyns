...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wxzsyns.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wxzsyns.containers.anotherwebservice.com/
...
```
git clone git@github.com:newone1103/container-wxzsyns.git
cd container-wxzsyns
```
...
```
docker attach container-wxzsyns
```
